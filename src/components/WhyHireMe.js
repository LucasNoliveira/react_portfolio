            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 1</h3>
                        <p className="text-gray-600">Descrição da Qualidade 1.</p>
                    </div>
                    {/* Item 2 */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 2</h3>
                        <p className="text-gray-600">Descrição da Qualidade 2.</p>
                    </div>
                    {/* Item 3 */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 3</h3>
                        <p className="text-gray-600">Descrição da Qualidade 3.</p>
                    </div>
                    {/* Item 4 */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 4</h3>
                        <p className="text-gray-600">Descrição da Qualidade 4.</p>
                    </div>
                    {/* Item 5 */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 5</h3>
                        <p className="text-gray-600">Descrição da Qualidade 5.</p>
                    </div>
                    {/* Item 6 */}
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-xl font-semibold mb-4">Qualidade 6</h3>
